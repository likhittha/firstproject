      ...
      <div className="bg-white h-[100vh]">
        <div className="flex p-8 justify-between items-center px-60 ">
          <div className=" flex justify-center items-center cursor-pointer ">
            <p className="text-3xl text-white bg-blue-500 rounded-full font-bold justify-center items-center flex h-9 w-9 ">
              {" "}
              R
            </p>
        ...
        <div className="justify-around flex flex-col items-center p-40">
          ...
          <p className="text-3xl font-bold ">
            I'm a
            <span style={{ fontWeight: "bold", color: "#5AB2FF" }}>
              {" "}
              {text}{" "}
            </span>
            <span>
              <Cursor cursorColor="#5AB2FF" />
            </span>
          </p>
        </div>
      </div>
